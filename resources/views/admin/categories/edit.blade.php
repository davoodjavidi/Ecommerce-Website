                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <div class="form-floating mb-md-0">
                                                            <input name="title" class="form-control" id="inputTitle" type="text" placeholder="Enter Post Title Here" value="{{$category->title}}"/>
                                                            <label for="inputTitle">Title</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mt-4 mb-0">
                                                    <div class="d-grid"><button type="submit" class="btn btn-primary btn-block">ویرایش</button></div>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
